...
public class ArticleVenduManagerTest {
	...
	public static void main(String[] args) throws BLLException {
			...
			ArticleVendu art1 = new ArticleVendu("Armoire Ika�", "Armoire Penderie", LocalDate.of(2022, 4, 9), LocalDate.of(2022, 5, 15), 150, 11, 4, "EC");
			ArticleVendu art2 = new ArticleVendu("Armoire Aki�", "Armoire Penderie", LocalDate.of(2022, 4, 9), LocalDate.of(2022, 5, 15), 132, 11, 4, "EC");
