...
<body>
	...
	<div id="wrapper">
		<header>
			<div class="logo">
				<a href="<%=request.getContextPath()%>/AccueilUserConnecteServlet"
					style="font-size: 40px;">ENI-Ench�res</a>
			</div>
			<div class="menu">
				<div>
					<a href="<%=request.getContextPath()%>/EncherirServlet"
						style="font-size: 23px;">Ench�res</a> <span class="line">--</span>
					...
					<a href="<%=request.getContextPath()%>/LogoutServlet"
						style="font-size: 23px;">D�connexion</a>
				</div>
			</div>
		</header>
		<h1 style="text-align: center;">D�tail de la vente</h1>
		...
		${articlemodel.current.description} <br> <br> Cat�gorie :
		${articlemodel.current.noCategorie.libelle} <br> <br>
		Meilleure offre : ${encheremodel.current.montantEnchere} <br> <br>
		Mise � prix : ${articlemodel.current.miseAPrix} <br> <br>
		Fin de l'ench�re : ${articlemodel.current.dateFinEncheres} <br> <br>
		...
		<footer>
			<div>
				<a href="<%=request.getContextPath()%>/AccueilUserConnecteServlet"
					style="font-size: 20px;">ENI-Ench�res</a> <span class="line">--</span>
				<a href="<%=request.getContextPath()%>/NouvelleVenteServlet"
					style="font-size: 20px;">Vendre un article</a> <span class="line">--</span>
				<a href="<%=request.getContextPath()%>/DetailVenteServlet"
					style="font-size: 20px;">Ench�res</a> <span class="line">--</span>
				<a href="<%=request.getContextPath()%>/MonProfilServlet"
					style="font-size: 20px;">Mon profil</a> <span class="line"></span>
			</div>
			<a style="text-align: center; color: #fefefe;">2022 ENI-Ench�res.
